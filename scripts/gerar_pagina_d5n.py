...
.skip-link{
  ...
  background:var(--accent);color:#0B0E14;font-weight:600;font-size:.8rem;
...
.pc-duration{font-family:var(--font-mono);font-size:.78rem;color:var(--text-2);font-variant-numeric:tabular-nums}
.pc-summary{
...
.btn{
  ...
  transition:color var(--t-fast) var(--ease),background var(--t-fast) var(--ease),transform var(--t-fast) var(--ease),box-shadow var(--t-fast) var(--ease),filter var(--t-fast) var(--ease);
}
...
.page-btn{
  ...
  transition:color var(--t-fast) var(--ease),border-color var(--t-fast) var(--ease),opacity var(--t-fast) var(--ease);
}
